...
export default function Calibration() {
  ...
  return (
    <Layout pageTitle="Calibration">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: 'Total Records', value: tabRecords.length, accent: 'from-indigo-500 to-purple-500' },
          { label: 'Pass', value: passCount, accent: 'from-emerald-500 to-teal-500' },
          { label: 'Fail', value: failCount, accent: 'from-red-500 to-rose-500' },
        ].map((s) => (
      ...
      >
        <div className="mb-4 p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg text-sm flex items-start gap-2">
          ...
          This calibration <strong>FAILED</strong>. It is recommended to create a CAPA.
        </div>
        <div className="space-y-4">
          <div>
