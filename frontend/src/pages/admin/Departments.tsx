  ...
  return (
    <Layout pageTitle="Departments">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {[
          { label: 'Total', value: departments.length, accent: 'from-indigo-500 to-purple-500' },
          { label: 'Active', value: departments.filter((d) => d.is_active).length, accent: 'from-emerald-500 to-teal-500' },
          { label: 'Gauge Rooms', value: departments.filter((d) => d.location_type === 'gauge_room').length, accent: 'from-blue-500 to-cyan-500' },
          { label: 'Shop Floors', value: departments.filter((d) => d.location_type === 'shop_floor').length, accent: 'from-amber-500 to-yellow-500' },
        ].map((s) => (
